...
export class ChangePasswordComponent implements OnInit {
  ...
  isNewPasswordCorrect: boolean = true;
  isConfirmationCorrect: boolean = true;

  onOldPasswordChange(oldPassword: NgModel) {
  ...
  onNewPasswordChange(newPassword: NgModel, confirmPassword: NgModel) {
  ...
  updateSubmitButtonStatus() {
    if (this.isOldPasswordCorrect && this.isNewPasswordCorrect && this.isConfirmationCorrect && this.form.oldPassword && this.form.newPassword && this.form.confirmPassword) {
      this.enableSubmitButton();
    } else {
      this.disableSubmitButton();
    }
